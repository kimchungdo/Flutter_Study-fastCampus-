                            ...
                            children: List.generate(wPart.length, (_idx){
                              return InkWell(
                                child: Container(
                                  ...
                                  child: Text(wPart[_idx],
                                    style: TextStyle(
                                      color: workout.part == _idx ? Colors.white : iTxtColor,            //클릭이 안됐으면 텍스트도 색깔 변화해야함
                                    ),),
                                  decoration: BoxDecoration(
                          ...
                          GridView.count(
                            ...
                            children: List.generate(wIntense.length, (_idx){
                              return InkWell(
                                child: Container(
                                  alignment: Alignment.center,
                                  child: Text(wIntense[_idx],
                                    style: TextStyle(
                                      color: workout.intense == _idx ? Colors.white : iTxtColor,            //클릭이 안됐으면 텍스트도 색깔 변화해야함
                                    ),),
                                  decoration: BoxDecoration(
                                    borderRadius: BorderRadius.circular(8),         //각지지않게
